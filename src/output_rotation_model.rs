...
impl OutputRotationModel {
    ...
    pub const fn swaps_axes(self) -> bool {
        matches!(self.rotation, OutputRotation::Deg90 | OutputRotation::Deg270)
    }
...
mod tests {
    ...
    fn model_derives_rotation_table() {
        ...
        assert_eq!(deg0.capture_pixel_rotation(), CapturePixelRotation::Identity);
        ...
        assert_eq!(deg180.capture_pixel_rotation(), CapturePixelRotation::Rotate180);
